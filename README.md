...
- Pricing is now shown on the product pages (e1 $199.99, i1 $799.99, r2 $2,499.99), pulled directly from the live Lemon Squeezy checkout pages. If pricing changes in Lemon Squeezy, update it here too — it isn't pulled dynamically.
